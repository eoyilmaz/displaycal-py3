...
def test_get_edid_1():
    ...
    with check_call(
        ...
        call_count=0 if platform.system() != "Linux" else 2,
    ):
        with check_call(
            RealDisplaySizeMM,
            "_enumerate_displays",
            DisplayData.enumerate_displays(),
            call_count=0 if platform.system() != "Linux" else 1,
        ):
            result = get_edid(0)
...
#     """Testing DisplayCAL.colord.device_id_from_edid() function."""                   # noqa: SC100
